...
cult1 = Cult.new("cult1", "New York", 1985, "Eat my Shorts", 21)
cult2 = Cult.new("cult2", "New York", 1987, "The World's Gonna End!", 18)
cult3 = Cult.new("cult3", "Connecticut", 1983, "Blood!", 0)
